...
const Banner = require("../Model/cakeBannerModel");
...
const createBanner = async (req, res) => {
    ...
    try {
        ...
        const banner = new Banner({
            ...
            titel,
            cakeBanner: req.file.path, // Save the file path
            // bannerType,
...
const updateBanner = async (req, res) => {
    try {
        ...
        if (req.file && banner.cakeBanner) {
            deleteImageFile(banner.cakeBanner);
            banner.cakeBanner = req.file.path;
        }
...
const deleteBanner = async (req, res) => {
    try {
        ...
        if (banner.cakeBanner) deleteImageFile(banner.cakeBanner);
