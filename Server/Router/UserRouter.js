const { createRecord, getSingleRecord, getRecord, getAdminUser, updateRolesByAdmin, login, forgetPassword1, forgetPassword2, forgetPassword3, DeleteRecord } = require("../Controller/UserController")
