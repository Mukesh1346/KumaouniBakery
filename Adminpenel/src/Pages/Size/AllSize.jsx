...
const AllSize = () => {
  ...
  useEffect(() => {
    const fetchSizes = async () => {
      try {
        const response = await axios.get("https://bakery-46ac.onrender.com/api/get-size"); // Adjust the URL for fetching sizes
    ...
    if (confirmed.isConfirmed) {
      try {
        const response = await axios.delete(
          `https://bakery-46ac.onrender.com/api/delete-size/${id}`
