...
const Header = () => {
  ...
  //       const res = await axios.get(
  //         // `https://www.ssdipl.com/api/search-products?query=${searchQuery}`
  //         ` https://www.ssdipl.com/api/get-best-selling-products?query=${searchQuery}`
                  ...
                  {searchQuery && (
                    <div className="search-suggestions">
                      ...
                      {productSuggestions.map((product) => (
                        ...
                        >
                          <img
                            src={`https://www.ssdipl.com/${product.productImage?.[0]?.replace(/\\/g, "/")}`}
