...
const Checkout = () => {
  ...
  //         'https://www.ssdipl.com/api/checkout', finalPayload
  //       )
  ...
  //     const res = await axios.post('https://www.ssdipl.com/api/checkout', finalPayload)
  ...
  //             "https://www.ssdipl.com/api/verify-payment",
  //             {
  ...
  const placeOrder = async () => {
    ...
    try {
      ...
      if (finalPayload.paymentMode === "cod") {
        const res = await axios.post(
          "https://www.ssdipl.com/api/checkout",
          finalPayload
        );
